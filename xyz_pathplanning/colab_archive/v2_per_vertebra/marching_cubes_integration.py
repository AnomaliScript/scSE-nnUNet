...
def run_complete_demonstration():
    ...
    # Define surgical trajectory (cervical screw path through C5)
    trajectory = np.array([
        [36.0, 30.0, 12.0],  # Entry point (posterior lateral, C5 level)
        [38.0, 26.0, 16.0],  # Through C5 vertebral body
        [40.0, 24.0, 20.0]   # Target (anterior C5 vertebral body)
    ])
